...
LOCAL_OKAPI_URL = "http://localhost:3000"
TENANT_ID = "diku"
...
OKAPI_ENV = [
    {"name": "DB_HOST", "value": f"localhost"},
    ...
    {"name": "KAFKA_HOST", "value": f"localhost"},
    {"name": "KAFKA_PORT", "value": f"9092"},
    {"name": "ENV", "value": f"dev"},
    {"name": "ELASTICSEARCH_URL", "value": f"http://localhost:9200"},
